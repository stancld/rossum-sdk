...
class SyncRossumAPIClient(
    ...
    def retrieve_annotation_processing_duration(
        ...
        https://rossum.app/api/docs/openapi/api/annotation/
        """
        data = self.internal_client.request_json(
            "GET",
    ...
    def retrieve_automation_insights(self, queue_id: int) -> AutomationStats:
        ...
        """
        data = self.internal_client.request_json("GET", build_automation_insights_url(queue_id))
        return self._deserializer(Resource.AutomationStats, data)

    def retrieve_automation_projections(
        self,
        queue_id: int,
    ...
    def list_automation_targets(self, queue_id: int) -> Iterator[AutomationTarget]:
    ...
    def create_new_automation_target(
        self,
        queue_id: int,
